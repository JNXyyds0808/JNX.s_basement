...
.jnx-login-gate-card {
  ...
  border-radius: 22px;
  background: rgba(133, 133, 255, 0.09);
...
.jnx-login-gate-card h2 {
  margin: 0 0 10px;
  font-size: 24px;
}
.jnx-login-gate-card p {
  margin: 0 0 22px;
  opacity: 0.72;
}
#jnxLoginGateButton {
...
`;
  ...
  if (document.readyState === "loading")
    document.addEventListener("DOMContentLoaded", initHomeGate, { once: true });
  else initHomeGate();
})();
