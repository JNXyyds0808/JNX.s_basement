(()=>{
  const entries=[
    {date:'2026-09-08',title:'文章档案与主页整合',text:'新增写作档案入口，并让 Archive 与 JNX 主站共用 Supabase 登录状态；主页加入写作档案快捷卡片与菜单入口。'},
    {date:'2026-09-08',title:'档案搜索优化',text:'重新调整 Archive 搜索逻辑：标题、地点和关键词匹配优先于正文匹配，并改进多关键词检索与结果排序。'},
    {date:'2026-09-08',title:'iPad 首页显示修复',text:'修复 iPad 横屏下“你好，我是 JNX.”被拆成两行的问题；保持原有字号，不再通过缩小标题来解决布局，并更新资源版本号以避免 Safari 继续使用旧缓存。'},
    {date:'2026-09-08',title:'档案访问权限加强',text:'收紧写作档案数据库权限：匿名用户无法读取，已登录用户仅保留读取权限。'},
    {date:'2026-08-26',title:'积分中心',text:'加入积分系统与每日任务：每日登录 +10、发送 3 条消息 +20、点击木鱼 10 次 +15、在线 10 分钟 +15。任务完成后会弹出提示，可手动领取积分；积分中心显示总积分与今日任务进度，为之后的积分商店做准备。'},
    {date:'2026-08-26',title:'成员与个人主页',text:'新增独立成员功能。可以查看网站成员的头像、Display Name、用户名、个性签名和在线状态；点击成员先进入 Profile，再通过 Chat 按钮直接发起私聊，同时保留聊天中的成员列表。'},
    {date:'2026-08-26',title:'手机聊天与木鱼修复',text:'修复手机端更新日志/公告入口覆盖聊天发送按钮的问题；清理木鱼小游戏重复的“摸头模式”控件，避免挡住右上角关闭按钮。'},
